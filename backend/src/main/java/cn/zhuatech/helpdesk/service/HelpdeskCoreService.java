...
public class HelpdeskCoreService {
    ...
    public static class TicketEvent{@Id @GeneratedValue(strategy=GenerationType.IDENTITY) public Long id;public Long ticketId;@Column(nullable=false,length=30)public String action;@Column(nullable=false,length=80)public String operatorName;@Column(length=500)public String detail;public LocalDateTime occurredAt;/**
                                                                                                                                                                                                                                                                                                                         * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                                                                                                                                                                                                                                         */
protected TicketEvent(){}/**
                                                                                                                                                                                                                                                                                                                                                  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                                                                                                                                                                                                                                                                  */
TicketEvent(Long ticketId,String action,String operator,String detail){this.ticketId=ticketId;this.action=action;this.operatorName=operator;this.detail=detail;this.occurredAt=LocalDateTime.now();}}
}
